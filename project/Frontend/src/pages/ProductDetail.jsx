        ...
        <div className="product-detail-info">
          ...
          {isTransport ? (
            <p>
              ...
              {product.distance.toLocaleString()} km
            </p>
          ) : (
            <>
              <p>
              ...
              <p>
                <strong>Used To:</strong>{" "}
                {new Date(product.usedTo).toLocaleDateString()}
              </p>
            </>
          )}
          ...
          {product.postedBy && (
            <>
              <p>
                <strong>Seller:</strong> {product.postedBy.name}
              </p>
              <p>
                <strong>Contact:</strong> +91-{product.postedBy.phone}
              </p>
            </>
          )}
        </div>
